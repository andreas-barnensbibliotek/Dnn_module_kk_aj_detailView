                        ...
                        <div class="box box-solid ">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked kk_aj_ansokanmenu">
                                    ...
                                    <li class="kk_aj_underbehandlingnsokanmenu"><a href="/KulturkatalogenAdmin/KatalogenAnsokningar?sida=kk_aj_underbehandlingansokningarView" class="kk_aj_underbehandlingansokningar2"><i class="fa fa-bookmark-o"></i>Under behandling<span class="label label-warning pull-right kk_aj_underbehandlingcount">0</span></a></li>                                    
